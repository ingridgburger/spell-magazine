      ...
      <section className="about-intro reveal-item">
        ...
        <div className="about-intro-content">
          ...
          <p className="text-body">
            ...
            young artists. Created by a team of students who are deeply involved
            in the arts themselves, SPELL was born from a shared desire to
            uplift local small creators and offer a platform where emerging
            voices can be seen, heard, and celebrated.
          </p>

          <p className="text-body">
            Twice a year, we publish a curated issue that highlights the talents
            of our contributors through a range of work including visual art,
            photography, fashion, music, poetry, and interviews. Our goal is to
            build a space that not only showcases artistic expression, but also
            fosters connection and collaboration within our community.
          </p>

          <p className="text-body about-intro-emphasis">
            At its core, SPELL is about honoring creativity and providing a
            space where beautiful, thoughtful work can be shared with the world.
          </p>
        </div>
      </section>
          ...
          {team.map((member) => (
            <div className="team-card" key={member.id}>
              ...
              >
                ...
                />
                <img src={linkedinIcon} alt="" className="team-linkedin-icon" />
              </a>
